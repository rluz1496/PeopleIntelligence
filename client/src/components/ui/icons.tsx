...
export function PerformanceIcon(props: LucideProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={props.className || "h-5 w-5"}
...
export function ClimateIcon(props: LucideProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={props.className || "h-5 w-5"}
...
export function Feedback360Icon(props: LucideProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={props.className || "h-5 w-5"}
...
export function ReportIcon(props: LucideProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={props.className || "h-5 w-5"}
...
export function PrintIcon(props: LucideProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={props.className || "h-5 w-5"}
